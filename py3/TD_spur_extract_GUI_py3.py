...
class Ui_Dialog_First_Window(object):
    def setupUi(self, Dialog):
        ...
        self.extract_spurs_button.shortcut = QtWidgets.QShortcut(QtGui.QKeySequence("Ctrl+R"), self.extract_spurs_button)
        self.extract_spurs_button.shortcut.activated.connect(self.extract)
        ...
        self.extract_spurs_button.setWhatsThis("Shortcut: Ctrl+R")
